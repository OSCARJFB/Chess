...
int main() {
    bool is_Running = true, playerTurn = true, validInput = false, chess = false, chessMate = false, opponent;
    int selectY, selectX, moveY, moveX, kingX, kingY;
    std::vector <char> movement;
    char piece, target, king;
    char board[8][8] = {'R', 'K', 'B', 'W','Q', 'B', 'K', 'R',
                        'P', 'P', 'P', 'P','P', 'P', 'P', 'P',
                        ' ', ' ', ' ', ' ',' ', ' ', ' ', ' ',
                        ' ', ' ', ' ', ' ',' ', ' ', ' ', ' ',
                        ' ', ' ', ' ', ' ',' ', ' ', ' ', ' ',
    ...
    while (is_Running) {
        ...
        while(validInput == false) validInput = getMove(&selectY, &selectX, &moveY, &moveX);
...
bool getMove(int* ptr_selectY, int* ptr_selectX, int* ptr_moveY, int* ptr_moveX) {
    char letFrom, numFrom, letTo, numTo;
